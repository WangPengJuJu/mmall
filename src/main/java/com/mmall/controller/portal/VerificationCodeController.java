...
public class VerificationCodeController{
    ...
    public void VerificationCode( HttpServletRequest request,
        ...
        // 将认证码存入SESSION
        request.getSession().setAttribute(Const.SESSION_KEY_OF_RAND_CODE, resultCode);
        // 图象生效
        graphics.dispose();
    ...
    private String exctractRandCode() {
        final String randCodeType = PropertiesUtil.getProperty("randCodeType");
        int randCodeLength = Integer.parseInt(PropertiesUtil.getProperty("randCodeLength"));
